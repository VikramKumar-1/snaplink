...
export async function GET() {
  const source =
    "C:\\Users\\vikur\\.gemini\\antigravity\\brain\\a113f34c-50eb-4dee-8bb6-11b733e4e70f\\.user_uploaded\\media_1788862579231.png";
  ...
  try {
    ...
    const targetFile = path.join(publicDir, "myntra-logo.png");
    if (fs.existsSync(source)) {
      fs.copyFileSync(source, targetFile);
    }
  } catch (err) {
    console.error("Failed to copy Myntra logo asset:", err);
  }

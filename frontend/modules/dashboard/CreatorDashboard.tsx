...
import { Link2, Plus, RefreshCw, User } from "lucide-react";
...
export const CreatorDashboard: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-8 sm:py-12">
      ...
      {/* Tab Switcher: Links Hub vs Bio Studio vs Custom Domains vs Developers vs Team */}
      <DashboardTabBar activeTab={dashboardTab} onTabChange={setDashboardTab} />

...
export const GalleryInstagramCard: React.FC = memo(() => (
  <div className="w-[185px] sm:w-48 md:w-56 h-[330px] sm:h-[390px] rounded-2xl bg-white border border-[#e4e2d8] p-3.5 sm:p-5 flex flex-col justify-between shadow-[0_10px_24px_-6px_rgba(0,0,0,0.07)] shrink-0 relative hover:border-pink-400 transition-colors snap-center">

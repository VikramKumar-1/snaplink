...
export const GalleryTelegramCard: React.FC = memo(() => (
  <div className="w-[170px] sm:w-40 md:w-48 h-[290px] sm:h-[340px] rounded-2xl bg-white border border-[#e4e2d8] p-3.5 sm:p-4 flex flex-col justify-between shadow-[0_8px_20px_-6px_rgba(0,0,0,0.06)] shrink-0 relative hover:border-sky-400 transition-colors snap-center">

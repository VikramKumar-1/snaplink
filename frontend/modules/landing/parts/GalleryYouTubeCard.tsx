...
export const GalleryYouTubeCard: React.FC = memo(() => (
  <div className="w-[170px] sm:w-36 md:w-40 lg:w-44 xl:w-48 h-[290px] sm:h-[320px] lg:h-[340px] rounded-2xl bg-white border border-[#e4e2d8] p-3.5 sm:p-4 flex flex-col justify-between shadow-[0_8px_20px_-6px_rgba(0,0,0,0.06)] shrink-0 relative sm:hover:border-red-400 transition-colors snap-center">

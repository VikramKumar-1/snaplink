...
export const ComparisonTableRow: React.FC<ComparisonTableRowProps> = memo(({ row }) => {
  return (
    <tr className="hover:bg-[#faf9f5]/70 transition-colors">
      <td className="py-3 sm:py-4 px-3.5 sm:px-6 text-black font-bold text-[12.5px] sm:text-[13.5px]">{row.feature}</td>
      ...
      <td className="py-3 sm:py-4 px-3.5 sm:px-6 bg-[#2c35af]/[0.04] border-x border-[#2c35af]/20">

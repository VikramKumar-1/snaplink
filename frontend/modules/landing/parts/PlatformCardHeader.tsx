...
export const PlatformCardHeader: React.FC<HeaderProps> = ({
  ...
  <div className="mb-4">
    <div className="flex items-center justify-between mb-3">
      <div className="h-11 w-11 sm:h-13 sm:w-13 rounded-2xl bg-white border border-black/[0.06] flex items-center justify-center p-2 sm:p-2.5 shadow-[inset_0_2.5px_3px_rgba(255,255,255,1),inset_0_-1.5px_2px_rgba(0,0,0,0.04),0_8px_18px_-3px_rgba(0,0,0,0.08)] group-hover:scale-110 group-hover:rotate-1 transition-all duration-300">

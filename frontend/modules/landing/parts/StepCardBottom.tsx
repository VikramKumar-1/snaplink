...
export const StepCardBottom: React.FC<BottomProps> = memo(({ isLast }) => (
  <div className="pt-3 border-t border-[#f0eee6] flex items-center justify-end">
    {isLast ? (
      ...
      <div className="h-6 w-6 rounded-full bg-[#faf9f5] border border-[#e7e5dc] group-hover:bg-[#2c35af] group-hover:text-white flex items-center justify-center text-zinc-400 transition-all duration-200 group-hover:scale-105">

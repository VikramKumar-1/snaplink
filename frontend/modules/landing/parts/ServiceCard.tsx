  ...
  return (
    ...
    >
      ...
      <div className="w-full pt-3 border-t border-black/[0.06] flex items-center justify-center">
        <span className="text-[11px] sm:text-[11.5px] font-bold text-zinc-800 flex items-center gap-1.5 bg-white/85 px-3 py-1 rounded-full border border-white/90 shadow-2xs">
